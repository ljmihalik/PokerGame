...
e=b.innerHTML.replace(f,"\x3c/script>");b=d(b);b.hasPassback=!0;return b}return{isBadImp:!0,hasPassback:!1,tagAdTag:c,tagPassback:e}};return d(b)}function J(b,c,e,f,d,g,l,k,q,t,h,w){void 0==c.dvregion&&(c.dvregion=0);try{f.depth=S(f);var n=T(f);var m="&aUrl="+encodeURIComponent(n.url);var p="&aUrlD="+n.depth;var v=f.depth+d;g&&f.depth--}catch(u){p=m=v=f.depth=""}void 0!=c.aUrl&&(m="&aUrl="+c.aUrl);a:{try{if("object"==typeof window.$ovv||"object"==typeof window.parent.$ovv){var r=1;break a}}catch(u){}r=
...
null!=a&&null!=(null!=a.querySelector('div[id*="opti-ad"]')||a.querySelector('iframe[src="about:blank"]'))):!1);f(17,10,b==b.top&&""==d.title&&b.InitAdPlayer?(a=d.querySelector('body>div[id="kt_player"]'),null!=a&&null!=a.querySelector('div[class="flash-blocker"]')):!1);f(17,11,null!=b.clickplayer&&null!=b.checkRdy2);f(19,12,b.instance&&b.inject&&d.querySelector('path[id="cp-search-0"]'));return{f:c,s:e}}catch(g){return null}}function aa(){try{var b="&fcifrms="+window.top.length;window.history&&(b+=
"&brh="+window.history.length);var c=K(),e=c.document;if(c==window.top){b+="&fwc="+((c.FB?1:0)+(c.twttr?2:0)+(c.outbrain?4:0)+(c._taboola?8:0));try{e.cookie&&(b+="&fcl="+e.cookie.length)}catch(f){}c.performance&&c.performance.timing&&0<c.performance.timing.domainLookupStart&&0<c.performance.timing.domainLookupEnd&&(b+="&flt="+(c.performance.timing.domainLookupEnd-c.performance.timing.domainLookupStart));e.querySelectorAll&&(b+="&fec="+e.querySelectorAll("*").length)}return b}catch(f){return""}}function W(){function b(b){if(null==
b||""==b)return"";var c=function(b,c){return b<<c|b>>>32-c},d=function(b){for(var c="",d,e=7;0<=e;e--)d=b>>>4*e&15,c+=d.toString(16);return c},e=[1518500249,1859775393,2400959708,3395469782];b+=String.fromCharCode(128);for(var f=Math.ceil((b.length/4+2)/16),h=Array(f),g=0;g<f;g++){h[g]=Array(16);for(var n=0;16>n;n++)h[g][n]=b.charCodeAt(64*g+4*n)<<24|b.charCodeAt(64*g+4*n+1)<<16|b.charCodeAt(64*g+4*n+2)<<8|b.charCodeAt(64*g+4*n+3)}h[f-1][14]=8*(b.length-1)/Math.pow(2,32);h[f-1][14]=Math.floor(h[f-
1][14]);h[f-1][15]=8*(b.length-1)&4294967295;b=1732584193;n=4023233417;var m=2562383102,p=271733878,v=3285377520,r=Array(80);for(g=0;g<f;g++){for(var u=0;16>u;u++)r[u]=h[g][u];for(u=16;80>u;u++)r[u]=c(r[u-3]^r[u-8]^r[u-14]^r[u-16],1);var D=b;var y=n;var x=m;var z=p;var A=v;for(u=0;80>u;u++){var E=Math.floor(u/20),B=c(D,5);a:{switch(E){case 0:var C=y&x^~y&z;break a;case 1:C=y^x^z;break a;case 2:C=y&x^y&z^x&z;break a;case 3:C=y^x^z;break a}C=void 0}E=B+C+A+e[E]+r[u]&4294967295;A=z;z=x;x=c(y,30);y=D;
D=E}b=b+D&4294967295;n=n+y&4294967295;m=m+x&4294967295;p=p+z&4294967295;v=v+A&4294967295}return d(b)+d(n)+d(m)+d(p)+d(v)}function c(){try{return!!window.sessionStorage}catch(g){return!0}}function e(){try{return!!window.localStorage}catch(g){return!0}}function f(){try{var b=document.createElement("canvas");if(b.getContext&&b.getContext("2d")){var c=b.getContext("2d");c.textBaseline="top";c.font="14px 'Arial'";c.textBaseline="alphabetic";c.fillStyle="#f60";c.fillRect(0,0,62,20);c.fillStyle="#069";c.fillText("!image!",
2,15);c.fillStyle="rgba(102, 204, 0, 0.7)";c.fillText("!image!",4,17);return b.toDataURL()}}catch(k){}return null}try{var d=[];d.push(["lang",navigator.language||navigator.browserLanguage]);d.push(["tz",(new Date).getTimezoneOffset()]);d.push(["hss",c()?"1":"0"]);d.push(["hls",e()?"1":"0"]);d.push(["odb",typeof window.openDatabase||""]);d.push(["cpu",navigator.cpuClass||""]);d.push(["pf",navigator.platform||""]);d.push(["dnt",navigator.doNotTrack||""]);d.push(["canv",f()]);return b(d.join("=!!!="))}catch(g){return null}}
this.createRequest=function(){var b=!1,c=window._dv_win,e=0,f=!1,d;try{for(d=0;10>=d;d++)if(null!=c.parent&&c.parent!=c)if(0<c.parent.location.toString().length)c=c.parent,e++,b=!0;else{b=!1;break}else{0==d&&(b=!0);break}}catch(v){b=!1}a:{try{var g=c.$sf;break a}catch(v){}g=void 0}if(0==c.document.referrer.length)b=c.location;else if(b)b=c.location;else{b=c.document.referrer;if(G(b)){a:{try{var l=c.$sf&&c.$sf.ext&&c.$sf.ext.hostURL&&c.$sf.ext.hostURL();break a}catch(v){}l=void 0}if(l&&!G(l)&&0==l.indexOf(b)){b=
l;var k=!0}}f=!0}if(!window._dv_win.dvbsScriptsInternal||!window._dv_win.dvbsProcessed||0==window._dv_win.dvbsScriptsInternal.length)return{isSev1:!1,url:null};d=window._dv_win.dv_config&&window._dv_win.dv_config.isUT?window._dv_win.dvbsScriptsInternal[window._dv_win.dvbsScriptsInternal.length-1]:window._dv_win.dvbsScriptsInternal.pop();l=d.script;this.dv_script_obj=d;this.dv_script=l;window._dv_win.dvbsProcessed.push(d);window._dv_win._dvScripts.push(l);var q=l.src;this.dvOther=0;this.dvStep=1;var t=
window._dv_win.dv_config?window._dv_win.dv_config.bst2tid?window._dv_win.dv_config.bst2tid:window._dv_win.dv_config.dv_GetRnd?window._dv_win.dv_config.dv_GetRnd():A():A();d=window.parent.postMessage&&window.JSON;var h=!0,w=!1;if("0"==dv_GetParam(q,"t2te")||window._dv_win.dv_config&&1==window._dv_win.dv_config.supressT2T)w=!0;if(d&&0==w)try{var n=H(window._dv_win.dv_config.bst2turl||"https://cdn3.doubleverify.com/bst2tv3.html","bst2t_"+t);h=B(n)}catch(v){}n={};try{w=/[\?&]([^&]*)=([^&#]*)/gi;for(var m=
w.exec(q);null!=m;)"eparams"!==m[1]&&(n[m[1]]=m[2]),m=w.exec(q);var p=n}catch(v){p=n}p.perf=this.perf;p.uid=t;p.script=this.dv_script;p.callbackName="__verify_callback_"+p.uid;p.tagObjectCallbackName="__tagObject_callback_"+p.uid;p.tagAdtag=null;p.tagPassback=null;p.tagIntegrityFlag="";p.tagHasPassbackFlag="";0==(null!=p.tagformat&&"2"==p.tagformat)&&(m=R(p.script),p.tagAdtag=m.tagAdTag,p.tagPassback=m.tagPassback,m.isBadImp?p.tagIntegrityFlag="&isbadimp=1":m.hasPassback&&(p.tagHasPassbackFlag="&tagpb=1"));
(m=(/iPhone|iPad|iPod|\(Apple TV|iOS|Coremedia|CFNetwork\/.*Darwin/i.test(navigator.userAgent)||navigator.vendor&&"apple, inc."===navigator.vendor.toLowerCase())&&!window.MSStream)?n="https:":(n=p.script.src,q="http:",t=window._dv_win.location.toString().match("^http(?:s)?"),"https"!=n.match("^https")||"https"!=t&&"http"==t||(q="https:"),n=q);p.protocol=n;p.ssl="0";"https:"===p.protocol&&(p.ssl="1");n=p;(q=window._dv_win.dvRecoveryObj)?("2"!=n.tagformat&&(q=q[n.ctx]?q[n.ctx].RecoveryTagID:q._fallback_?
q._fallback_.RecoveryTagID:1,1===q&&n.tagAdtag?document.write(n.tagAdtag):2===q&&n.tagPassback&&document.write(n.tagPassback)),n=!0):n=!1;if(n)return{isSev1:!0};this.dvStep=2;Q(p,m);l=l&&l.parentElement&&l.parentElement.tagName&&"HEAD"===l.parentElement.tagName;this.dvStep=3;return J(this,p,b,c,e,f,d,h,l,m,k,g)};this.sendRequest=function(b){var c=dv_GetParam(b,"tagformat");c&&"2"==c?$dvbs.domUtilities.addScriptResource(b,document.body):dv_sendScriptRequest(b);try{if("1"!=dv_GetParam(b,"foie")){var e=
N(this.dv_script_obj&&this.dv_script_obj.injScripts),f=H("about:blank");f.id=f.name;var d=f.id.replace("iframe_","");f.setAttribute&&f.setAttribute("data-dv-frm",d);B(f,this.dv_script);if(this.dv_script){var g=this.dv_script;a:{b=null;try{if(b=f.contentWindow){var l=b;break a}}catch(t){}try{if(b=window._dv_win.frames&&window._dv_win.frames[f.name]){l=b;break a}}catch(t){}l=null}g.dvFrmWin=l}var k=O(f);if(k)k.open(),k.write(e);else{try{document.domain=document.domain}catch(t){}var q=encodeURIComponent(e.replace(/'/g,
"\\'").replace(/\n|\r\n|\r/g,""));f.src='javascript: (function(){document.open();document.domain="'+window.document.domain+"\";document.write('"+q+"');})()"}}}catch(t){e=(window._dv_win.dv_config=window._dv_win.dv_config||{}).tpsAddress||"tps30.doubleverify.com",dv_SendErrorImp(e+"/verify.js?ctx=818052&cmp=1619415",[{dvp_jsErrMsg:"DvFrame: "+encodeURIComponent(t)}])}return!0};this.isApplicable=function(){return!0};this.onFailure=function(){};window.debugScript&&(window.CreateUrl=J);this.getVersionParamName=
function(){return"ver"};this.getVersion=function(){return"105"}};
